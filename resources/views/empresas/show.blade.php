...
@section('content')
    <div class="px-4 md:px-10 mx-auto w-full -m-24 flex flex-wrap">
        <div class="flex flex-wrap mt-4 w-1/2">
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                                <h3 class="font-semibold text-base text-gray-800">
                                    Listado Certificados Digitales
                                </h3>
                            </div>
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                                <a class="justify-center w-full px-4 py-2 text-sm font-medium text-white bg-yellow-600
                                    ...
                                    focus:shadow-outline-yellow active:bg-yellow-700 transition duration-150 ease-in-out" style="margin-top: -10px;margin-bottom: 5px" href="{{ route('certificadosDigitales.subir', ['company' => $company->id]) }}">
                                    Subir
                                </a>
                            </div>
                        </div>
                    </div>
                    @include('empresas.certificados_table')
                </div>
            </div>
        </div>

        <div class="flex flex-wrap mt-4 w-full">
            <div class="w-1/2 mb-12 xl:mb-0 px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    ...
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                                <a class="justify-center w-full px-4 py-2 text-sm font-medium text-white bg-yellow-600
                                    border border-transparent rounded-md hover:bg-yellow-500 focus:outline-none focus:border-yellow-700
                                    focus:shadow-outline-yellow active:bg-yellow-700 transition duration-150 ease-in-out" style="margin-top: -10px;margin-bottom: 5px" href="{{ route('cafs.subir', ['company' => $company->id]) }}">
                                    Subir
                                </a>
                            </div>
                        </div>
                    </div>
                    @include('empresas.cafs_table')
                </div>
            </div>
        </div>
