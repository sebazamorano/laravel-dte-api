<div>
    <div class="block w-full overflow-x-auto">
        <table class="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
            @foreach($company->actividadesEconomicasEmpresas as $economicActivity)
                <tr>
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $economicActivity->codigo }}</td>
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $economicActivity->descripcion }}</td>
                </tr>
            @endforeach
