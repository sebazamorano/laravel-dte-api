            ...
            <div class="w-full mb-12 xl:mb-0 px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        ...
                        {!! Form::open(['route' => ['cafs.upload', $company->id], 'class'=> 'flex flex-wrap -mx-2 overflow-hidden px-8 lg:px-0 sm:px-0 xl:px-0 w-full', 'files' => true]) !!}

                            <!-- Line Field -->
                            <div class="my-2 px-2 w-full overflow-hidden sm:w-full md:w-full lg:w-1/2 xl:w-1/2">
                                {!! Form::label('caf', 'CAF'.':', ['class' => 'text-grey-darker block uppercase tracking-wide text-xs font-bold mt-3 mb-1']) !!}
                                {!! Form::file('caf', null, ['class' => 'form-input w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline',]) !!}
                            </div>

                            <!-- Password Sii Field -->
                            <div class="my-2 px-2 w-full overflow-hidden sm:w-full md:w-full lg:w-1/2 xl:w-1/2">
                                {!! Form::label('folioActual', 'Folio Actual'.':', ['class' => 'text-grey-darker block uppercase tracking-wide text-xs font-bold mt-3 mb-1']) !!}
                                {!! Form::text('folioActual', null, ['class' => 'border form-input w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline']) !!}
                            </div>

                            <div class="my-2 px-2 w-full overflow-hidden sm:w-full md:w-full lg:w-1/2 xl:w-1/2">
                                {!! Form::label('enUso', 'En Uso'.':', ['class' => 'text-grey-darker block uppercase tracking-wide text-xs font-bold mt-3 mb-1']) !!}
                                {!! Form::checkbox('enUso', 'true', false, ['class' => 'py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline',]) !!}
                            </div>
